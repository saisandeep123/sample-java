...
<html>
    ...
    <body>
        ...
        <h1>Build is Available:: Jenkins -> Deploy -> Nexus -> Tomcat7 --> poll scm --> dependenet --> qa --> prod </h1>
        <h1>Build is Available:: Jenkins -> Deploy -> Nexus -> Tomcat7 --> poll scm --> dependenet --> qa --> prod-->testing </h1>
